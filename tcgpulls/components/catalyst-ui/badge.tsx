...
const colors = {
  primary:
    "bg-primary-600/10 text-primary-700 group-data-[hover]:bg-primary-600/20 dark:bg-white/5 dark:text-primary-400 dark:group-data-[hover]:bg-white/10",
  secondary:
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    "group relative inline-flex rounded-md focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2",
  );
