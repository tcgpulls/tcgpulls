...
const colors = {
  primary: [
    "[--switch-bg-ring:theme(colors.primary.950/90%)] [--switch-bg:theme(colors.primary.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white/25%)]",
    "[--switch-ring:theme(colors.primary.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:theme(colors.primary.700/90%)]",
  ],
  secondary: [
    "[--switch-bg-ring:theme(colors.secondary.950/90%)] [--switch-bg:theme(colors.secondary.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white/25%)]",
    "[--switch-ring:theme(colors.secondary.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:theme(colors.secondary.700/90%)]",
  ],
  accent: [
    "[--switch-bg-ring:theme(colors.accent.950/90%)] [--switch-bg:theme(colors.accent.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white/25%)]",
    "[--switch-ring:theme(colors.accent.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:theme(colors.accent.700/90%)]",
  ],
  "dark/zinc": [
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked
        "bg-primary-200 ring-1 ring-inset ring-black/5 dark:bg-white/5 dark:ring-white/15",
        // Checked
        ...
        // Disabled
        "data-[disabled]:bg-primary-200 data-[disabled]:data-[checked]:bg-primary-200 data-[disabled]:opacity-50 data-[disabled]:data-[checked]:ring-black/5",
