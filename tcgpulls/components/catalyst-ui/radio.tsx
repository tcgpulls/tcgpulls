...
const base = [
  ...
  // Border
  "border border-primary-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-primary-950/30 group-data-[checked]:bg-[--radio-checked-border]",
  ...
  "group-data-[disabled]:border-primary-950/25 group-data-[disabled]:bg-primary-950/5 group-data-[disabled]:[--radio-checked-indicator:theme(colors.zinc.950/50%)] group-data-[disabled]:before:bg-transparent",
...
const colors = {
  primary: [
    "[--radio-checked-bg:theme(colors.primary.900)] [--radio-checked-border:theme(colors.primary.950/90%)] [--radio-checked-indicator:theme(colors.white)]",
    "dark:[--radio-checked-bg:theme(colors.primary.600)]",
  ],
  secondary: [
    "[--radio-checked-bg:theme(colors.secondary.900)] [--radio-checked-border:theme(colors.secondary.950/90%)] [--radio-checked-indicator:theme(colors.white)]",
    "dark:[--radio-checked-bg:theme(colors.secondary.600)]",
  ],
  accent: [
    "[--radio-checked-bg:theme(colors.accent.900)] [--radio-checked-border:theme(colors.accent.950/90%)] [--radio-checked-indicator:theme(colors.white)]",
    "dark:[--radio-checked-bg:theme(colors.accent.600)]",
  ],
  "dark/zinc": [
